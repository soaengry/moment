...
public enum InvitationErrorCode {
    // Invitation
    INVITATION_NOT_FOUND("초대장 정보를 찾을 수 없습니다"),
    INVITATION_UNAUTHORIZED("해당 초대장에 대한 권한이 없습니다"),

    // Template
    TEMPLATE_NOT_FOUND("템플릿을 찾을 수 없습니다"),

    // Couple
    COUPLE_NOT_FOUND("주최자 정보를 찾을 수 없습니다"),

    // Schedule
    SCHEDULE_NOT_FOUND("일정 정보를 찾을 수 없습니다"),
