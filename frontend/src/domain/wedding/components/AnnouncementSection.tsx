  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-40 flex items-center gap-2 px-4 py-3 rounded-full bg-primary text-white shadow-lg hover:bg-primaryHover transition-colors"
      >
        <svg
                ...
                <div
                  ...
                  className={`p-4 rounded-xl ${
                    announcement.isPinned
                      ? "bg-bgPrimary border border-primary/20"
                      : "bg-gray-50"
                  }`}
                >
