...
import { IoClose, IoLocation, IoOpen, IoTrash } from "react-icons/io5";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm mx-4 overflow-hidden">
        <div className="flex items-center justify-between p-4 border-b border-gray-100">
          <h3 className="text-lg font-semibold text-gray-800">일정 정보</h3>
          <button
            onClick={onClose}
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="flex items-start gap-2 text-sm text-gray-600">
            ...
            <div>
              <p>{attendance.locationName}</p>
              <p className="text-gray-400 text-xs">{attendance.locationAddress}</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-2 p-4 border-t border-gray-100">
          <button
            onClick={() => navigate(`/event/${attendance.slug}`)}
